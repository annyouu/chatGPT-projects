    ...
    <div className="h-screen flex flex-col items-center justify-center">
      <form
        ...
        <div className="flex justify-end">
          <button type="submit" className="bg-blue-500 text-white rounded font-bold  px-4 py-2 hover:bg-blue-700 ">ログイン</button>
        </div>
        ...
        <div className="mt-4">
          ...
          <Link href={"/auth/login"} className="text-blue-500 font-bold  ml-1 ">新規登録ページへ</Link>
        </div>
